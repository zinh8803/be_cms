    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET posts/suggestions' => 'post/suggestions',
                ...
                'GET admin/post-views' => 'admin/post-views-index',
                'GET admin/notifications' => 'admin/notification-index',
                'PUT admin/notifications/<id:\d+>/read' => 'admin/notification-read',
                'PUT admin/notifications/read-all' => 'admin/notification-read-all',
